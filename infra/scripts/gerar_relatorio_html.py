...
with UnitOfWork() as uow:
    lancamento_processado_llm = LancamentoProcessadoLlmService(uow)

    for item_lancamento_id in lista_lancamento_id_processado():
        grupo_lancamentos = lancamento_processado_llm.listar_por_lancamento_arquivo_id_ordenado(2, item_lancamento_id)
