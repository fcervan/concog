...
if __name__ == "__main__":
    event = {'Records': [
        {'eventVersion': '2.1', 'eventSource': 'aws:s3', 'awsRegion': 'sa-east-1',
         'eventTime': '2026-03-17T03:42:39.910Z', 'eventName': 'ObjectCreated:Put', 'userIdentity':
             ...
             {'s3SchemaVersion': '1.0', 'configurationId': 'trigger-xlsx-arquivo-original', 'bucket':
                 ...
                 {'key': 'cc/arquivo-original/2026/03/16/1/1/nao-conciliado-3-grupos.xlsx', 'sequencer': '0055AED6DCD90281E5', 'eTag': '1f76dd5472649005af5d98155d47af09', 'size': 119473}}}]}
